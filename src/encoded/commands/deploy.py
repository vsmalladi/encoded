...
def parse_args():
    ...
    parser.add_argument('--iam-role', default='encoded-instance', help="Set AWS iam role.  New one, post pg11 is encd-prod")
    parser.add_argument('--iam-role-es', default='elasticsearch-instance', help="Set AWS iam role for elasticsearch")
